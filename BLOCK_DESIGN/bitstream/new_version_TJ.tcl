...
proc create_root_design { parentCell } {
  ...
  # Create instance: FSRCNN_0, and set properties
  set FSRCNN_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:FSRCNN:1.0 FSRCNN_0 ]
  ...
  connect_bd_intf_net -intf_net FSRCNN_0_stream_out [get_bd_intf_pins FSRCNN_0/stream_out] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins FSRCNN_0/stream_in] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs FSRCNN_0/s_axi_scalar_parameters/Reg] SEG_FSRCNN_0_Reg
