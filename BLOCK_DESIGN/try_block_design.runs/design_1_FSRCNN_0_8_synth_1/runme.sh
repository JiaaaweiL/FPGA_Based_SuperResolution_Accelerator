...
HD_PWD='E:/UIUC_GRAD/UIUC_ECE527/Final_project/try_block_design/try_block_design.runs/design_1_FSRCNN_0_8_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_FSRCNN_0_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_FSRCNN_0_8.tcl
