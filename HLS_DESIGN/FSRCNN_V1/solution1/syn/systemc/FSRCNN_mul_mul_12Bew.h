...
// ==============================================================
#ifndef __FSRCNN_mul_mul_12Bew__HH__
#define __FSRCNN_mul_mul_12Bew__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(FSRCNN_mul_mul_12Bew) {
    ...
    SC_CTOR(FSRCNN_mul_mul_12Bew):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
