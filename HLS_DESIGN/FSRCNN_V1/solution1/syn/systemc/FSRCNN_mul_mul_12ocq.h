...
// ==============================================================
#ifndef __FSRCNN_mul_mul_12ocq__HH__
#define __FSRCNN_mul_mul_12ocq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(FSRCNN_mul_mul_12ocq) {
    ...
    SC_CTOR(FSRCNN_mul_mul_12ocq):  ACMP_smul_su_U ("ACMP_smul_su_U") {
