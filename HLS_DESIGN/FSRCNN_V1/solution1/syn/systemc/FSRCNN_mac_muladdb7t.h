...
// ==============================================================
#ifndef __FSRCNN_mac_muladdb7t__HH__
#define __FSRCNN_mac_muladdb7t__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(FSRCNN_mac_muladdb7t) {
    ...
    SC_CTOR(FSRCNN_mac_muladdb7t):  simcore_mac_0_U ("simcore_mac_0_U") {
