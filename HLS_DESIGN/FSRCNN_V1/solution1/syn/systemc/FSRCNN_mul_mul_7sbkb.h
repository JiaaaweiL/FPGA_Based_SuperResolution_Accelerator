...
// ==============================================================
#ifndef __FSRCNN_mul_mul_7sbkb__HH__
#define __FSRCNN_mul_mul_7sbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(FSRCNN_mul_mul_7sbkb) {
    ...
    SC_CTOR(FSRCNN_mul_mul_7sbkb):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
