...
// ==============================================================
#ifndef __FSRCNN_mul_mul_12CeG__HH__
#define __FSRCNN_mul_mul_12CeG__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(FSRCNN_mul_mul_12CeG) {
    ...
    SC_CTOR(FSRCNN_mul_mul_12CeG):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
