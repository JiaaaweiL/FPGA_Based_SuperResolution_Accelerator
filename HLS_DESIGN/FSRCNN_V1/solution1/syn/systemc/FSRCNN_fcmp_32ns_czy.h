...
// ==============================================================
#ifndef __FSRCNN_fcmp_32ns_czy__HH__
#define __FSRCNN_fcmp_32ns_czy__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(FSRCNN_fcmp_32ns_czy) {
    ...
    SC_CTOR(FSRCNN_fcmp_32ns_czy):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
