...
reg   [0:0] icmp_ln1299_reg_896_pp0_iter9_reg;
reg    ap_enable_reg_pp0_iter11;
reg   [0:0] icmp_ln1299_reg_896_pp0_iter10_reg;
reg   [14:0] i_0_reg_290;
wire   [0:0] icmp_ln1299_fu_311_p2;
...
reg   [0:0] icmp_ln1299_reg_896_pp0_iter1_reg;
reg   [0:0] icmp_ln1299_reg_896_pp0_iter2_reg;
reg   [0:0] icmp_ln1299_reg_896_pp0_iter3_reg;
reg   [0:0] icmp_ln1299_reg_896_pp0_iter4_reg;
reg   [0:0] icmp_ln1299_reg_896_pp0_iter5_reg;
reg   [0:0] icmp_ln1299_reg_896_pp0_iter6_reg;
reg   [0:0] icmp_ln1299_reg_896_pp0_iter7_reg;
reg   [0:0] icmp_ln1299_reg_896_pp0_iter8_reg;
...
wire   [8:0] tmp_44_fu_634_p3;
wire   [31:0] p_Result_13_fu_641_p5;
wire   [31:0] bitcast_ln739_fu_653_p1;
wire   [31:0] bitcast_ln1305_fu_664_p1;
wire   [7:0] tmp_38_fu_667_p4;
wire   [22:0] trunc_ln1305_fu_677_p1;
wire   [0:0] icmp_ln1305_1_fu_687_p2;
wire   [0:0] icmp_ln1305_fu_681_p2;
wire   [0:0] or_ln1305_fu_693_p2;
wire   [0:0] grp_fu_301_p2;
wire   [0:0] and_ln1305_fu_699_p2;
wire   [31:0] bitcast_ln1307_fu_712_p1;
wire   [7:0] tmp_40_fu_715_p4;
wire   [22:0] trunc_ln1307_fu_725_p1;
wire   [0:0] icmp_ln1307_1_fu_735_p2;
wire   [0:0] icmp_ln1307_fu_729_p2;
wire   [0:0] or_ln1307_fu_741_p2;
wire   [0:0] grp_fu_306_p2;
wire   [0:0] and_ln1307_fu_747_p2;
wire   [31:0] p_Val2_41_fu_753_p3;
...
wire   [0:0] tmp_86_fu_853_p3;
wire   [78:0] r_V_4_fu_847_p2;
wire   [31:0] zext_ln662_fu_861_p1;
wire   [31:0] tmp_126_fu_865_p4;
...
FSRCNN_fcmp_32ns_czy #(
    .ID( 1 ),
    .NUM_STAGE( 2 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 1 ))
FSRCNN_fcmp_32ns_czy_U186(
    .clk(ap_clk),
    .reset(ap_rst),
...
always @ (posedge ap_clk) begin
    if (((icmp_ln1299_fu_311_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln1299_reg_896_pp0_iter8_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        add_ln339_reg_1018 <= add_ln339_fu_787_p2;
        isNeg_reg_1023 <= add_ln339_fu_787_p2[32'd8];
        p_Result_14_reg_1008 <= p_Val2_41_fu_753_p3[32'd31];
...
always @ (posedge ap_clk) begin
    if (((icmp_ln1299_reg_896_pp0_iter6_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln1299_reg_896_pp0_iter4_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln1299_reg_896 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln935_reg_936_pp0_iter2_reg == 1'd0) & (icmp_ln1299_reg_896_pp0_iter2_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln935_reg_936 == 1'd0) & (icmp_ln1299_reg_896_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln935_reg_936_pp0_iter3_reg == 1'd0) & (icmp_ln1299_reg_896_pp0_iter3_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        m_4_reg_985 <= {{m_1_fu_590_p2[31:1]}};
        tmp_83_reg_990 <= m_1_fu_590_p2[32'd25];
    end
end
...
always @ (*) begin
    if ((icmp_ln1299_fu_311_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((icmp_ln1299_reg_896 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln1299_reg_896 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((((icmp_ln1299_reg_896_pp0_iter10_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter11 == 1'b1)) | ((icmp_ln1299_reg_896_pp0_iter9_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter10 == 1'b1)))) begin
...
always @ (*) begin
    if (((icmp_ln1299_reg_896_pp0_iter9_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter10 == 1'b1))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((icmp_ln1299_fu_311_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) & ~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter10 == 1'b0) & (ap_enable_reg_pp0_iter11 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((icmp_ln1299_fu_311_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter10 == 1'b0) & (ap_enable_reg_pp0_iter11 == 1'b1)))) begin
...
assign and_ln1305_fu_699_p2 = (or_ln1305_fu_693_p2 & grp_fu_301_p2);

assign and_ln1307_fu_747_p2 = (or_ln1307_fu_741_p2 & grp_fu_306_p2);
...
always @ (*) begin
    ap_block_pp0_stage0_00001 = ((icmp_ln1299_reg_896 == 1'd0) & (io_acc_block_signal_op29 == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_01001 = ((icmp_ln1299_reg_896 == 1'd0) & (io_acc_block_signal_op29 == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_block_state13_io) & (ap_enable_reg_pp0_iter11 == 1'b1)) | ((1'b1 == ap_block_state12_io) & (ap_enable_reg_pp0_iter10 == 1'b1)) | ((icmp_ln1299_reg_896 == 1'd0) & (io_acc_block_signal_op29 == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((1'b1 == ap_block_state13_io) & (ap_enable_reg_pp0_iter11 == 1'b1)) | ((1'b1 == ap_block_state12_io) & (ap_enable_reg_pp0_iter10 == 1'b1)) | ((icmp_ln1299_reg_896 == 1'd0) & (io_acc_block_signal_op29 == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end
...
always @ (*) begin
    ap_block_state12_io = ((icmp_ln1299_reg_896_pp0_iter9_reg == 1'd0) & (stream_out_V_data_V_1_ack_in == 1'b0));
end

assign ap_block_state12_pp0_stage0_iter10 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state13_io = ((icmp_ln1299_reg_896_pp0_iter10_reg == 1'd0) & (stream_out_V_data_V_1_ack_in == 1'b0));
end
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter1 = ((icmp_ln1299_reg_896 == 1'd0) & (io_acc_block_signal_op29 == 1'b0));
end
...
assign bitcast_ln1305_fu_664_p1 = data_util_reg_995_pp0_iter6_reg;

assign bitcast_ln1307_fu_712_p1 = data_util_1_reg_1002_pp0_iter8_reg;

assign bitcast_ln739_fu_653_p1 = p_Result_13_fu_641_p5;

assign data_util_1_fu_705_p3 = ((and_ln1305_fu_699_p2[0:0] === 1'b1) ? 32'd1132396544 : data_util_reg_995_pp0_iter6_reg);
...
assign icmp_ln1299_fu_311_p2 = ((i_0_reg_290 == 15'd16384) ? 1'b1 : 1'b0);

assign icmp_ln1305_1_fu_687_p2 = ((trunc_ln1305_fu_677_p1 == 23'd0) ? 1'b1 : 1'b0);

assign icmp_ln1305_fu_681_p2 = ((tmp_38_fu_667_p4 != 8'd255) ? 1'b1 : 1'b0);

assign icmp_ln1307_1_fu_735_p2 = ((trunc_ln1307_fu_725_p1 == 23'd0) ? 1'b1 : 1'b0);

assign icmp_ln1307_fu_729_p2 = ((tmp_40_fu_715_p4 != 8'd255) ? 1'b1 : 1'b0);
...
assign icmp_ln947_fu_461_p2 = (($signed(tmp_81_fu_451_p4) > $signed(31'd0)) ? 1'b1 : 1'b0);
...
assign or_ln1305_fu_693_p2 = (icmp_ln1305_fu_681_p2 | icmp_ln1305_1_fu_687_p2);

assign or_ln1307_fu_741_p2 = (icmp_ln1307_fu_729_p2 | icmp_ln1307_1_fu_735_p2);
...
assign p_Result_13_fu_641_p5 = {{tmp_44_fu_634_p3}, {m_5_fu_613_p1[22:0]}};
...
assign p_Val2_41_fu_753_p3 = ((and_ln1307_fu_747_p2[0:0] === 1'b1) ? 32'd0 : bitcast_ln1307_fu_712_p1);

assign p_Val2_43_fu_888_p3 = ((p_Result_14_reg_1008[0:0] === 1'b1) ? result_V_1_fu_882_p2 : p_Val2_s_fu_875_p3);

assign p_Val2_s_fu_875_p3 = ((isNeg_reg_1023[0:0] === 1'b1) ? zext_ln662_fu_861_p1 : tmp_126_fu_865_p4);

assign r_V_4_fu_847_p2 = zext_ln682_fu_816_p1 << zext_ln1287_fu_837_p1;

assign r_V_fu_841_p2 = mantissa_V_fu_807_p4 >> sext_ln1311_2_fu_833_p1;

assign result_V_1_fu_882_p2 = (32'd0 - p_Val2_s_fu_875_p3);

assign select_ln964_fu_616_p3 = ((tmp_83_reg_990[0:0] === 1'b1) ? 8'd127 : 8'd126);
...
assign tmp_126_fu_865_p4 = {{r_V_4_fu_847_p2[55:24]}};

assign tmp_38_fu_667_p4 = {{bitcast_ln1305_fu_664_p1[30:23]}};

assign tmp_40_fu_715_p4 = {{bitcast_ln1307_fu_712_p1[30:23]}};

assign tmp_44_fu_634_p3 = {{p_Result_11_reg_941_pp0_iter4_reg}, {add_ln964_fu_628_p2}};

assign tmp_81_fu_451_p4 = {{lsb_index_fu_445_p2[31:1]}};

assign tmp_82_fu_504_p3 = lsb_index_fu_445_p2[32'd31];

assign tmp_86_fu_853_p3 = r_V_fu_841_p2[32'd24];

assign tmp_V_1_fu_396_p3 = ((p_Result_11_reg_941[0:0] === 1'b1) ? sub_ln939_fu_391_p2 : trunc_ln1118_reg_930);

assign tmp_V_2_fu_769_p4 = {{p_Val2_41_fu_753_p3[30:23]}};

assign tmp_V_3_fu_779_p1 = p_Val2_41_fu_753_p3[22:0];
...
assign trunc_ln1305_fu_677_p1 = bitcast_ln1305_fu_664_p1[22:0];

assign trunc_ln1307_fu_725_p1 = bitcast_ln1307_fu_712_p1[22:0];
