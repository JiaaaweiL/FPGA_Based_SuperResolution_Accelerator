...
set C_modelName {CORRELATE.1}
set C_modelType { void 0 }
set C_modelArgList {
	{ prev_output_channel_V int 12 regular {array 5508 { 1 3 } 1 1 }  }
	{ filter_V int 12 regular {array 9 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "prev_output_channel_V", "interface" : "memory", "bitwidth" : 12, "direction" : "READONLY"} , 
 	{ "Name" : "filter_V", "interface" : "memory", "bitwidth" : 12, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ filter_V_address0 sc_out sc_lv 4 signal 1 } 
	{ filter_V_ce0 sc_out sc_logic 1 signal 1 } 
	{ filter_V_q0 sc_in sc_lv 12 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "filter_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "filter_V", "role": "address0" }} , 
 	{ "name": "filter_V_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "filter_V", "role": "ce0" }} , 
 	{ "name": "filter_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "filter_V", "role": "q0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.FSRCNN_mul_mul_12CeG_U56", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1153", "Max" : "2881"}
	, {"Name" : "Interval", "Min" : "1153", "Max" : "2881"}
]}
...
set Spec2ImplPortList { 
	...
	filter_V { ap_memory {  { filter_V_address0 mem_address 1 4 }  { filter_V_ce0 mem_ce 1 1 }  { filter_V_q0 mem_dout 0 12 } } }
