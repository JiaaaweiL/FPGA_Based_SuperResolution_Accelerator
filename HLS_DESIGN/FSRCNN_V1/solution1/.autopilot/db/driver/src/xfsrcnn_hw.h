...
#define XFSRCNN_SCALAR_PARAMETERS_BITS_HEIGHT_V_DATA       8
#define XFSRCNN_SCALAR_PARAMETERS_ADDR_WIDTH_V_DATA        0x18
#define XFSRCNN_SCALAR_PARAMETERS_BITS_WIDTH_V_DATA        8
#define XFSRCNN_SCALAR_PARAMETERS_ADDR_SCALE_FACTOR_V_DATA 0x20
#define XFSRCNN_SCALAR_PARAMETERS_BITS_SCALE_FACTOR_V_DATA 2
